...
![Иллюстрация работы Бота](/assets/projects/command-bot/run-bot-demo.gif){: width="600" height="auto"}
...
![Логика создания Бота](/assets/projects/command-bot/bot-creation-logic.png){: .center width="600" height="auto"}

### Логика - Как это работает

![Пример использования Бота](/assets/projects/command-bot/bot-usage-example.gif){: width="600" height="auto"}

<p class="notation">Пример: вспомнить команду для работы над сайтом - чтобы видеть изменения в реальном времени, в браузере</p>
...
![Логика работы Бота](/assets/projects/command-bot/bot-work-logic.png){: .center width="600" height="auto"}
