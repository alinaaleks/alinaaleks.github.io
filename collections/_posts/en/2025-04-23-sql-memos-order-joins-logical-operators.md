...
![Image showing order of querying and execution](/assets/posts/sql-memos/order-of-querying-execution.webp){: .center width="600" height="auto"}
...
![SQL Joins illustrated in Venn diagrams](/assets/posts/sql-memos/sql-joins.webp){: .center width="600" height="auto"}
...
![SQL Logical operators and wildcards](/assets/posts/sql-memos/sql-logical-operators.webp){: .center width="600" height="auto"}
