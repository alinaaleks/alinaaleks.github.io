...
![Screenshot - initial table output](/assets/posts/more-sql/duplicates-00-initial-table.webp){: .center width="400" height="auto"}
...
![Screenshot - checking for duplicates output](/assets/posts/more-sql/duplicates-01-check.webp){: .center width="400" height="auto"}
...
![Screenshot - output with ctid column](/assets/posts/more-sql/duplicates-02-ctids.webp){: .center width="400" height="auto"}
...
![Screenshot - output with MIN ctids](/assets/posts/more-sql/duplicates-03-min-ctids.webp){: .center width="400" height="auto"}
...
![Screenshot - check if duplicates are deleted, final output](/assets/posts/more-sql/duplicates-04-final-result.webp){: .center width="400" height="auto"}
...
![Screenshot - table with missing values](/assets/posts/more-sql/missing-values-00-initial-table.webp){: .center width="400" height="auto"}
...
![Screenshot - output for checking for missing values](/assets/posts/more-sql/missing-values-01-check.webp){: .center width="400" height="auto"}
...
![Screenshot - output for checking for missing values - with empty strings](/assets/posts/more-sql/missing-values-01-check-with-strings.webp){: .center width="400" height="auto"}
...
![Screenshot - output for counting missing values](/assets/posts/more-sql/missing-values-02-count.webp){: .center width="400" height="auto"}
