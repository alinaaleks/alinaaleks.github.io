...
![Git Bash examples](/assets/posts/hacker-skills/git-bash-example.webp){: .center width="600" height="auto"}

---

Project on this topic: [Command Bot in Telegram](/projects/command-bot)
